...
If you want to develop templates on your local machine, BaseKit provides you with a Local Template Viewer to enable you to use your own code editor and tools of choice. Follow these instructions to get you started with developing templates locally.
